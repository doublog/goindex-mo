...
// 在head 中 加载 必要静态
document.write(
  '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/doublog/goindex-mo/css/mdui.min.css">'
);
document.write(
  '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/doublog/goindex-mo/css/nexmoe.min.css">'
);
// markdown支持
document.write(
  '<script src="//cdn.jsdelivr.net/gh/doublog/goindex-mojs/markdown-it.min.js"></script>'
);
document.write(
...
document.write(
  '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/doublog/goindex-mo/css/DPlayer.min.css">'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/doublog/goindex-mo/js/DPlayer.min.js"></script>'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/doublog/goindex-mo/js/hls.min.js"></script>'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/doublog/goindex-mo/js/flv.min.js"></script>'
);
...
<header class="nexmoe-nav">
    <div class="navSize">
			<a href="/"><img class="avatar" src="https://cdn.jsdelivr.net/gh/doublog/goindex-mo/images/icon.png"/></a>
			<div class="nav_menu">
				<ul class="menu_ul">
					<li class="menu_li"><a href="https://www.doublog.com" target="_blank">博客</a></li>
					<li class="menu_li"><a href="https://daohang.eu.org" target="_blank">导航</a></li>
				</ul>
...
<script src="//cdn.jsdelivr.net/gh/doublog/goindex-mo/js/ace.js"></script>
<script src="//cdn.jsdelivr.net/gh/doublog/goindex-mo/js/ext-language_tools.js"></script>
	`;
  $("#content").html(content);
